...
#define  DEVICE_ENV_USE_EEPROM                 0            /*是否使用EEPROM保存环境变量 如果是否 则使用flash*/

#define  DEVICE_MIN_ERASE_SIZE                 2048         /*最小擦除单元大小 bytes*/
#define  DEVICE_ADDR_MAP_LIMIT                 0x08040000   /*设备最大地址映射*/  

#define  BOOTLOADER_BASE_ADDR                  0x00000000UL /*bootloader基地址*/
#define  BOOTLOADER_SIZE_LIMIT                 0x8000       /*bootloader最大容量*/

#define  APPLICATION_SIZE_LIMIT                0x11800      /*application最大容量*/

#define  APPLICATION_BASE_ADDR                 0x08008000UL /*application基地址*/

#define  APPLICATION_BACKUP_BASE_ADDR          0x08019800UL /*application备份基地址*/

#define  APPLICATION_UPDATE_BASE_ADDR          0x0802B000UL /*application更新基地址*/
...
/*使用flash*/
#else
#define  DEVICE_ENV_BASE_ADDR                  0x0803C800   /*环境变量基地址*/   
#define  DEVICE_ENV_BACKUP_BASE_ADDR           0x0803D000   /*环境变量备份基地址*/         
